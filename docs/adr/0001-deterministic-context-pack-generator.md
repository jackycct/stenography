...
Avionics already owns orchestration, Codebrain owns repo understanding, and AgentLens owns telemetry/eval reporting.
...
- Architecture boundaries stay clear across Avionics, Codebrain, and AgentLens.
